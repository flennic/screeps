...
var factory = {
    run: function () {
        ...
        if(builders.length < CNT_BUILDERS) {
            var newBuilder = Game.spawns[SPAWN_NAME].createCreep([WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE], undefined, {role: "builder", busy: false});
        ...
        if(upgraders.length < CNT_UPGRADERS){
            var newUpgrader = Game.spawns[SPAWN_NAME].createCreep([WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE], undefined, {role: 'upgrader', busy: false});
